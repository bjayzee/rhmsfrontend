    ...
    return (
        <div className="border border-[gray] p-4 m-2 rounded-xl">
            ...
            <div className='flex justify-between'>
                ...
                <div className=" flex ">
                    <button className="bg-rh-blue text-white px-2  rounded-md h-6" onClick={() => updateItem("minus")}>-</button>
                    <input value={phone.quantity} readOnly
                        className='w-5 ml-2' />
                    <button className="bg-rh-blue text-white px-2 h-6 rounded-md" onClick={() => updateItem("plus")}>+</button>
                </div>
            </div>
