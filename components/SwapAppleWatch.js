          ...
          {createSpace !== false && (
            <div>
              ...
              <div className="font-bold  text-sm m-5">
                <h2>
                  Browse through our available options and make your selection
                </h2>
              </div>
            ...
            <div>
              {createSpace !== false && (
                <div>
                  ...
                  {/* {removeItem !== false && ( */}
                  <div
                    style={{ borderColor: "#187EB4" }}
                    className="border  px-8 m-8 rounded-lg  "
                  >
                ...
                <div className="my-5">
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      onChange={() => handleStorageSelect("45MM")}
                      class=" w-4 h-8 "
                      style={{ marginTop: "3px" }}
                    />
              ...
              <div className="my-5">
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    onChange={() =>
                      handleMaterialSelection("braided-solo-loop")
                    }
                    class=" w-4 h-8 "
                    style={{ marginTop: "3px" }}
                  />
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    onChange={() =>
                      handleBandSelection("space-black-link-bracket")
                    }
                    class=" w-4 h-8 "
                    style={{ marginTop: "3px" }}
                  />
                                              ...
                                              {removeItem !== false && (
                                                <div className="my-5">
                                                  ...
                                                  <div className="flex">
                                                    ...
                                                    />
                                                    <p className="pl-2 mx-1 mt-2 mr-7">
                                                      41MM
                                                    </p>
                                                    <input
                                                      type="radio"
