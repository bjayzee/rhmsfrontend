...
function CreateProduct() {
  ...
  const handleCreateProduct = async (e) => {
    ...
    axios
      .post("/api/products", formDataForBackend, {
        headers: {
                ...
                <Col>
                  <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Select
                      ...
                      value={productFormData.specification.grade} // Set the selected value
                    >
                      <option>------</option>
                ...
                <Col>
                  <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Select
                      ...
                      aria-label="Default select example"
                      required
                      onChange={handleSimChange} // Add onChange handler
                      value={productFormData.specification.sim} // Set the selected value
                    >
                      <option>------</option>
                ...
                <Col>
                  <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Select
                      ...
                      value={productFormData.specification.capacity} // Set the selected value
                    >
                      <option>------</option>
                ...
                <Col>
                  <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Select
                      ...
                      value={productFormData.specification.color} // Set the selected value
                    >
                      <option>------</option>
                ...
                <Col>
                  <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Select
                      ...
                      value={productFormData.category} // Set the selected value
                    >
                      <option>------</option>
                      {category_list}
                    </Form.Select>
                ...
                <Col>
                  <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Select
                      ...
                      aria-label="Default select example"
                      required
                      onChange={handleProductTypeChange} // Add onChange handler
                      value={productFormData.productType} // Set the selected value
                    >
                      <option>------</option>
