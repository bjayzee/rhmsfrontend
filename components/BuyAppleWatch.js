...
const BuyAppleWatch = () => {
  ...
  return (
    <div className="overflow-x-hidden py-5 px-5">
      ...
      {showBox ? (
        <div className="w-fit mb-3 gap-1 font-semibold text-sm flex flex-col ">
      ...
      {selectedModel === modelIndex ? (
        <>
          ...
          <div className="px-5">
            ...
            {watchSize != null ? (
              <div>
                {removeItem !== false ? (
                  <div className="flex flex-col space-y-3 my-5 text-lg">
                    <span className="font-bold">
                      Select your watch's case material
                    </span>
                    <div className="flex space-x-3">
                      <label className="flex items-center space-x-1">
                        <input
                    ...
                    <div className="flex space-x-3">
                      <label className="flex items-center space-x-1">
                        <input
                          ...
                          onChange={() =>
                            handleStorageSelection("Stainless-steel")
                          }
                        />
                        Stainless steel
                      </label>
            ...
            {materialState !== null ? (
              <div className="flex flex-col space-y-3 text-lg my-5">
                <span className="font-bold">Select your band type</span>
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <label className="">
                    <input
                      ...
                      onChange={() => {
                        handleBandType("Braided Solo Loop");
                      }}
                    />
                    Braided Solo Loop
                  </label>
                  ...
                  <label className="m-3 ">
                    <input
                      ...
                      onChange={() => {
                        handleBandType(" Space Black Link Bracelet");
                      }}
                    />
                  ...
                  <label className="m-3 ">
                    <input
                      ...
                      onChange={() => {
                        handleBandType(" Silver Link Bracelet");
                      }}
                    />
