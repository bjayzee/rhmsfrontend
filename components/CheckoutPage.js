  ...
  return (
    ...
    <span className="font-bold text-[#000000] text-2xl">1 used iPhone 11 Pro Max 512GB unlocked pink</span>
     ...
     <div className="flex space-x-5 font-bold my-5">
        <Link className="border-2 w-1/2 border-[#D3D3D3] text-[#187EB4] py-5 rounded-2xl flex items-center justify-center" href="/signin-page">I'w like it delivered</Link>
        <Link className="border-2 w-1/2 border-[#D3D3D3] text-[#187EB4] py-5 rounded-2xl flex items-center justify-center" href="/checkoutPage">I’w pick it up</Link>
      </div> 
